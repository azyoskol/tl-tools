...
export const InlineInsight = ({ text, action }) => (
  <div style={{ background: 'rgba(180,76,255,0.06)', border: '1px solid rgba(180,76,255,0.18)', borderRadius: 10, padding: '12px 14px', display: 'flex', gap: 10 }}>
    <div style={{ width: 22, height: 22, borderRadius: 6, background: 'rgba(180,76,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Icon name="sparkles" size={12} color="#B44CFF" /></div>
