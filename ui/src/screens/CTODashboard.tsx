  ...
  return (
    <div className="fade-up-2" style={{ padding: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <Widget><h3 style={{ marginBottom: 16 }}>Engineering Health</h3><Gauge value={data.payload.healthScore} label="Score" /></Widget>
        <Widget><h3 style={{ marginBottom: 16 }}>Deploy Trend</h3><AreaChart data={data.payload.deployTrend} width={350} height={150} /></Widget>
      </div>
    </div>
  );
};