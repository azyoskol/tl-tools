...
export const CTODashboard = () => {
  ...
  // Последние значения
  const lastDeploy = deployFreq.length ? deployFreq[deployFreq.length - 1].toFixed(1) : '4.2';
  const lastLead = leadTime.length ? leadTime[leadTime.length - 1].toFixed(1) : '2.1';
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
      ...
      <div className="fade-up-2" style={{ gridColumn: 'span 3' }}>
        <Widget>
          ...
          <AreaChart data={deployFreq} labels={weekLabels} color="#00E5FF" height={150} />
        </Widget>
      </div>
      ...
      <div className="fade-up-4" style={{ gridColumn: 'span 2' }}>
        <Widget>
          ...
          <AreaChart data={leadTime} compare={makeTimeSeries(30, 22, 8, 0, 99)} labels={weekLabels} color="#B44CFF" height={150} />
        </Widget>
      </div>
