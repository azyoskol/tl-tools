...
export const Leaderboard = ({ items, color = '#00E5FF', unit = '', title }: LeaderboardProps) => {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
        {items.map((item, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 18, fontSize: 11, color: 'var(--muted)', fontFamily: 'var(--font-mono)', textAlign: 'center', flexShrink: 0 }}>{i + 1}</div>
            ...
            <div style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: i === 0 ? color : 'var(--muted2)', width: 56, textAlign: 'center', flexShrink: 0 }}>
